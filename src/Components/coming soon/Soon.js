...
import BeerCanvas from "../BeerCanvas/BeerCanvas";
import "./soon.css";
  ...
  return (
    <>
      <section className="min-h-screen  flex items-center justify-center bg-gradient-to-br from-yellow-500 to-red-600 relative">
        ...
        <BeerCanvas/>
        <div className="coming_content text-white text-center z-50">
          <h1 className="text-4xl font-bold tracking-wider leading-none">
            Coming Soon
          </h1>
          <div className="separator_container text-center  py-5">
            <div className="separator line_separator mx-auto text-white w-44">
              <span>
                <svg
          ...
          <h3 className="font-body text-lg leading-6 tracking-wider">
            I like Food. Oh, and Javascript too.
          </h3>
        </div>
      </section>
    </>
